...
group chart3_g (hmcs_1/hmcs_0)*100 (bcb_cus_1/bcb_cus_0)*100 (bcb_cs_1/bcb_cs_0)*100

smpl 1 40

freeze(chart1) chart1_g.line
chart1.addtext(t) SHOCK TO CHINA PROPENSITY TO IMPORT
chart1.elem(1) legend(China output)
chart1.elem(2) legend(US output)

freeze(chart2) chart2_g.line
chart2.addtext(t) SHOCK TO CHINA PROPENSITY TO IMPORT
...
chart3.addtext(t) SHOCK TO CHINA PROPENSITY TO IMPORT
